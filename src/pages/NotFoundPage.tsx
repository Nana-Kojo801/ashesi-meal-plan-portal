...
export function NotFoundPage() {
  return (
    <div style={{
      minHeight: '100vh', background: '#FBF6F0', color: '#1C1413',
      display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
      padding: '32px 24px', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif",
    }}>
      <div style={{
        display: 'flex', alignItems: 'center', gap: 10, marginBottom: 40,
      }}>
        <div style={{
          width: 36, height: 36, borderRadius: 11, background: '#D81E2C',
      ...
      <div style={{
        background: '#fff', border: '1px solid #ECE0D4', borderRadius: 24,
        padding: '36px 32px', maxWidth: 400, width: '100%', textAlign: 'center',
        boxShadow: '0 22px 46px -24px rgba(110,30,18,.30)',
      }}>
        <div style={{
          width: 56, height: 56, borderRadius: 18, background: '#F2E7DC',
        ...
        <div style={{
          ...
          color: '#1C1413', lineHeight: 1, marginBottom: 8,
        }}>
          404
        </div>
        ...
        <Link
          ...
          style={{
            ...
            marginTop: 24, width: '100%', padding: '13px 20px', borderRadius: 13,
            background: '#D81E2C', color: '#fff', fontWeight: 700, fontSize: 14,
            textDecoration: 'none', boxShadow: '0 12px 22px -12px rgba(216,30,44,.55)',
            fontFamily: 'inherit',
          }}
        >
          Go to dashboard
